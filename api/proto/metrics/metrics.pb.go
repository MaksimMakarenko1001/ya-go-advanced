...
// 	protoc        v7.34.1
// source: api/proto/metrics/metrics.proto
...
func (Metric_MType) Descriptor() protoreflect.EnumDescriptor {
	return file_api_proto_metrics_metrics_proto_enumTypes[0].Descriptor()
}

func (Metric_MType) Type() protoreflect.EnumType {
	return &file_api_proto_metrics_metrics_proto_enumTypes[0]
}
...
func (x *Metric) Reset() {
	*x = Metric{}
	mi := &file_api_proto_metrics_metrics_proto_msgTypes[0]
...
func (x *UpdateMetricsRequest) Reset() {
	*x = UpdateMetricsRequest{}
	mi := &file_api_proto_metrics_metrics_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *UpdateMetricsResponse) Reset() {
	*x = UpdateMetricsResponse{}
	mi := &file_api_proto_metrics_metrics_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_api_proto_metrics_metrics_proto protoreflect.FileDescriptor

const file_api_proto_metrics_metrics_proto_rawDesc = "" +
	"\n" +
	"\x1fapi/proto/metrics/metrics.proto\x12\ametrics\"\x90\x01\n" +
	"\x06Metric\x12\x0e\n" +
	...
	"\aMetrics\x12N\n" +
	"\rUpdateMetrics\x12\x1d.metrics.UpdateMetricsRequest\x1a\x1e.metrics.UpdateMetricsResponseb\x06proto3"

var file_api_proto_metrics_metrics_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_api_proto_metrics_metrics_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_api_proto_metrics_metrics_proto_goTypes = []any{
...
var file_api_proto_metrics_metrics_proto_depIdxs = []int32{
...
func init() { file_api_proto_metrics_metrics_proto_init() }
func file_api_proto_metrics_metrics_proto_init() {
	if File_api_proto_metrics_metrics_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_proto_metrics_metrics_proto_rawDesc), len(file_api_proto_metrics_metrics_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_api_proto_metrics_metrics_proto_goTypes,
		DependencyIndexes: file_api_proto_metrics_metrics_proto_depIdxs,
		EnumInfos:         file_api_proto_metrics_metrics_proto_enumTypes,
		MessageInfos:      file_api_proto_metrics_metrics_proto_msgTypes,
	}.Build()
	File_api_proto_metrics_metrics_proto = out.File
	file_api_proto_metrics_metrics_proto_goTypes = nil
	file_api_proto_metrics_metrics_proto_depIdxs = nil
}
